        ...
        <div class="container mt-5 mb-5">
            <div class="card p-4 shadow">
                ...
                if ($_SERVER['REQUEST_METHOD'] == "POST") {
                    ...
                    if ($pencarian != "") {
                ?>
                        <h3>Hasil rekomendasi untuk kategori buku: <span class='text-primary'><?php echo htmlspecialchars($pencarian) ?> </span></h3>
                        <div class="mt-4">
                            <form method="get">
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST" && $pencarian != "") {
              ...
              SELECT DISTINCT
                ...
                FROM 
                    buku b
                LEFT JOIN 
                    model m ON m.antecedents_id = b.biblio_id
                WHERE 
                    b.kategori LIKE '%$pencarian%'
                GROUP BY 
                    b.biblio_id
                ORDER BY 
                    borrowed_count DESC, 
